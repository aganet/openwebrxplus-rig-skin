...
- Follows the latest change in the new OpenWebRX+ plugin windows. On the
  coming OpenWebRX+ release the DX cluster, the satellite map and the
  watch windows open in OpenWebRX+ windows; 0.10.8 missed that change.
  On older OpenWebRX+ versions nothing changes.
